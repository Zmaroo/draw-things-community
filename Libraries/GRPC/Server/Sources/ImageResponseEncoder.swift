...
enum ImageResponseEncoder {
    static func encodePreviewImage(
        from previewTensor: Tensor<FloatType>,
        responseFormat: RequestedImageResponseFormat,
...
#if canImport(CoreGraphics) && canImport(ImageIO) && canImport(UniformTypeIdentifiers)
    private static func encodedImageData(from tensor: Tensor<FloatType>, format: EncodedImageFormat) -> Data? {
